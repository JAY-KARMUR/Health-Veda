 ...
 *
 * This script helps set up the Health Veda database
 */

// Display header
echo "===========================================\n";
echo "Health Veda Database Setup\n";
echo "===========================================\n\n";
...
// Create database
echo "Creating database 'health_veda_db'...\n";
$sql = "CREATE DATABASE IF NOT EXISTS health_veda_db";
...
if ($conn->query($sql) === TRUE) {
    echo "Quiz results table created successfully.\n";
} else {
    echo "Error creating quiz_results table: " . $conn->error . "\n";
}
...
echo "===========================================\n";
echo "\nYou can now use the Health Veda website with database functionality.\n";
echo "Visit http://localhost/Health_Veda/ to get started.\n";
?>
